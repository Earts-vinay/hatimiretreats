...
const Awesome = () => {
  return (
    <div className="background-container">
      <div className="awesome-image d-flex align-items-center ">
        {/* Heading and Description */}
        <div className="container text-white">
          <div className="row">
            <div className="col-lg-9">
              <span className="px-5 mx-5 mobileresponsive">WHY WE ARE AWESOME!</span>
        ...
        <h2 className="display-4">
              ...
              <p className="mx-5 px-5 mobileresponsive">
